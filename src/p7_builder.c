...
static int    calibrate            (P7_BUILDER *bld, P7_HMM *hmm, P7_BG *bg, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, P7_FS_OPROFILE **opt_om_fs3, P7_FS_OPROFILE **opt_om_fs5);
 ...
 */
int
p7_Builder(P7_BUILDER *bld, ESL_MSA *msa, P7_BG *bg, P7_HMM **opt_hmm, P7_TRACE ***opt_trarr, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, P7_FS_OPROFILE **opt_om_fs3, P7_FS_OPROFILE **opt_om_fs5, ESL_MSA **opt_postmsa)
{
  ...
  if ((status =  calibrate            (bld, hmm, bg, opt_gm, opt_om, opt_om_fs3, opt_om_fs5)) != eslOK) goto ERROR;
 ...
 */
static int
calibrate(P7_BUILDER *bld, P7_HMM *hmm, P7_BG *bg, P7_PROFILE **opt_gm, P7_OPROFILE **opt_om, P7_FS_OPROFILE **opt_om_fs3, P7_FS_OPROFILE **opt_om_fs5)
{
  int status;

  if (opt_gm     != NULL) *opt_gm     = NULL;
  if (opt_om     != NULL) *opt_om     = NULL;
  if (opt_om_fs3 != NULL) *opt_om_fs3 = NULL;
  if (opt_om_fs5 != NULL) *opt_om_fs5 = NULL;
  
  if ((status = p7_Calibrate(hmm, bld, &(bld->r), &bg, opt_gm, opt_om, opt_om_fs3, opt_om_fs5)) != eslOK) goto ERROR;
  return eslOK;
