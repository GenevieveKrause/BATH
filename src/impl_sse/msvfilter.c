 ...
 * Synopsis:  Finds windows with SSV scores above some threshold
 *
 ...
 *            om      - optimized profile
 *            ox      - DP matrix
 *            ssvdata    - compact representation of substitution scores, for backtracking diagonals
