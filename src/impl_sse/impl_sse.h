...
extern int p7_ForwardParser_Frameshift_3Codons_New  (const ESL_DSQ *dsq, int L, const P7_OPROFILE    *om,                        P7_OMX *ox,  float *opt_sc);
...
extern int p7_BackwardParser_Frameshift_3Codons_New (const ESL_DSQ *dsq, int L, const P7_OPROFILE    *om,    const P7_OMX *fwd, P7_OMX *bck, float *opt_sc);
extern int p7_ForwardParser_Frameshift_5Codons     (const ESL_DSQ *dsq, int L, const P7_FS_OPROFILE *om_fs,                    P7_OMX *ox,  float *opt_sc);
extern int p7_ForwardParser_Frameshift_5Codons_New (const ESL_DSQ *dsq, int L, const P7_OPROFILE    *om,                        P7_OMX *ox,  float *opt_sc);
