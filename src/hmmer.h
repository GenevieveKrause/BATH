...
typedef struct p7_fs_profile_s {
  float  *tsc;                            /* transitions  [0.1..M-1][0..p7P_NTRANS-1], hand-indexed           */
  float **rsc;                            /* codon emissions [0..p7P_MAXCODONS+Kp-1][0..M], hand-indexed      */
...
extern int p7_GBackward_Frameshift_New(const ESL_DSQ *dsq, int L, const P7_PROFILE *gm,         P7_GMX *gx, P7_IVX *iv, float *opt_sc);
...
extern int p7_domaindef_ByPosteriorHeuristics_Frameshift_BATH(P7_PIPELINE *pli, ESL_SQ *windowsq, P7_OPROFILE *om_fs, P7_FS_OPROFILE *om_fs5, P7_FS_PROFILE *gm_fs5, P7_BG *bg, const ESL_GENCODE *gcode);
